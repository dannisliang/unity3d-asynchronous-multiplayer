...
public class FacebookUtil : MonoBehaviour {
	...
	public static Dictionary<string, string> DeserializeJSONProfile(string response, string[] fields)
	{
		...
		foreach (var field in fields) {
			object fieldValue;
			if (responseObject.TryGetValue(field, out fieldValue))
			{
				profile[field] = (string) fieldValue;
			}
		}
		return profile;
	}
